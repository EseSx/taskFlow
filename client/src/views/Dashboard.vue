...
const highPriority   = computed(() => tasks.value.filter(t => t.priority === 'HIGH' && !t.completed).length)
...
const recentTasks = computed(() =>
  tasks.value.filter(t => !t.completed).slice(0, 5)
)
        ...
        <div class="flex items-center justify-between mb-3">
          ...
          <div class="w-8 h-8 rounded-xl bg-white/5 flex items-center justify-center">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M2 4h12M2 8h12M2 12h8" stroke="white" stroke-opacity=".5" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between mb-3">
          ...
          <div class="w-8 h-8 rounded-xl bg-yellow-400/10 flex items-center justify-center">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              ...
              <path d="M8 5v3l2 2" stroke="#facc15" stroke-opacity=".8" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between mb-3">
          ...
          <div class="w-8 h-8 rounded-xl bg-green-400/10 flex items-center justify-center">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              ...
              <path d="M5.5 8l2 2 3-3" stroke="#4ade80" stroke-opacity=".8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
        </div>
      ...
      <div class="bg-white/5 border border-white/8 rounded-2xl p-5">
        <div class="flex items-center justify-between mb-3">
          ...
          <div class="w-8 h-8 rounded-xl bg-red-400/10 flex items-center justify-center">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M8 2l6 12H2L8 2z" stroke="#f87171" stroke-opacity=".8" stroke-width="1.5" stroke-linejoin="round"/>
              <path d="M8 7v3M8 11.5v.5" stroke="#f87171" stroke-opacity=".8" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
          </div>
        </div>

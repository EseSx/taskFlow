  ...
  >
    ...
    <div class="flex items-center gap-3 px-5 h-16 border-b border-white/5 shrink-0">
      <div class="w-7 h-7 bg-blue-500 rounded-lg flex items-center justify-center shrink-0">
        <span class="text-white text-xs font-bold cursor-default">TF</span>
      </div>

      <span class="text-white font-semibold text-sm tracking-wide cursor-default"> TaskFlow </span>
    </div>

    <!-- Navigation -->
    <nav class="flex-1 px-3 py-4 overflow-y-auto">
      <p
        class="text-white/30 text-xs font-medium uppercase tracking-widest px-2 mb-3 cursor-default"
      >
        Menú
      </p>
    ...
    <!-- User info al fondo -->
    <div class="px-3 pb-4 border-t border-white/5 pt-4 shrink-0 cursor-default">
